...
const ru: Dict = {
  ...
  'ai.method': 'Способ готовки',
  'cook.raw': 'Сырые',
  'cook.boiled': 'Варёные',
  'cook.steamed': 'На пару',
  'cook.baked': 'Запечённые',
  'cook.grilled': 'На гриле',
  'cook.stewed': 'Тушёные',
  'cook.sauteed': 'Обжаренные',
  'cook.fried': 'Жареные',
  'cook.deep_fried': 'Во фритюре',
...
const en: Dict = {
  ...
  'ai.method': 'Cooking method',
  'cook.raw': 'Raw',
  'cook.boiled': 'Boiled',
  'cook.steamed': 'Steamed',
  'cook.baked': 'Baked',
  'cook.grilled': 'Grilled',
  'cook.stewed': 'Stewed',
  'cook.sauteed': 'Sautéed',
  'cook.fried': 'Fried',
  'cook.deep_fried': 'Deep-fried',
...
const uk: Dict = {
  ...
  'ai.method': 'Спосіб приготування',
  'cook.raw': 'Сирі',
  'cook.boiled': 'Варені',
  'cook.steamed': 'На парі',
  'cook.baked': 'Запечені',
  'cook.grilled': 'На грилі',
  'cook.stewed': 'Тушковані',
  'cook.sauteed': 'Підсмажені',
  'cook.fried': 'Смажені',
  'cook.deep_fried': 'У фритюрі',
