...
import { Mail, Loader2, Flame, Sparkles, ShieldCheck, RefreshCw } from 'lucide-react';
            ...
            <div className="bg-[#f0f9ef] p-6 rounded-3xl border border-[var(--color-primary)]/10 text-center space-y-4 shadow-sm">
              ...
              <div className="space-y-1">
                <p className="text-sm font-bold text-[var(--color-primary-dark)]">
                  {t('auth.sent').split(' — ')[0] || t('auth.sent')}
                </p>
                <p className="text-xs text-[var(--color-text-light)] leading-relaxed">
                  {t('auth.sent').split(' — ')[1] || ''}
                </p>
            ...
            <form onSubmit={sendMagicLink} className="space-y-5">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-2xl border border-gray-200 bg-gray-50/50 text-sm text-[var(--color-text)] px-4 py-3.5 outline-none focus:border-[var(--color-primary)] focus:bg-white focus:ring-2 focus:ring-[var(--color-primary)]/10 transition-all shadow-sm"
                />
              </div>
